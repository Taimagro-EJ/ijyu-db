        ...
        {hasFacilityData && (
          ...
          <Section title="🧘 ウェルビーイング">
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(160px, 1fr))', gap: 12 }}>
              ...
              <FacilityCard municipalityId={municipalityId} municipalityName={m.name as string} category="cafe" label="カフェ" expectedCount={(m.cafe_starbucks ?? 0) as number} value={`${m.cafe_starbucks ?? 0}軒`} source={SOURCES.facility} />
            </div>
          </Section>
          {/* E. おでかけと暮らし */}
