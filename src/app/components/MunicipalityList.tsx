        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <nav style={{ display: 'flex', gap: 20, alignItems: 'center' }}>
              <a href="/blog" style={{ fontSize: 13, color: 'var(--color-base)', textDecoration: 'none', transition: 'color 0.2s' }}
                onMouseEnter={e => (e.currentTarget as HTMLAnchorElement).style.color = '#fff'}
                onMouseLeave={e => (e.currentTarget as HTMLAnchorElement).style.color = 'var(--color-base)'}
              >コラム</a>
              <a href="/about" style={{ fontSize: 13, color: 'var(--color-base)', textDecoration: 'none', transition: 'color 0.2s' }}
                onMouseEnter={e => (e.currentTarget as HTMLAnchorElement).style.color = '#fff'}
                onMouseLeave={e => (e.currentTarget as HTMLAnchorElement).style.color = 'var(--color-base)'}
              >データについて</a>
            </nav>
