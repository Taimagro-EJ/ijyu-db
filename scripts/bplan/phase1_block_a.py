...
BLOCK_A_PREFS = {'22','47','29','33','40','23','44','34','27','41','16','17','05','09','21','14','15'}
PREF_ROMA = {'22':'shizuoka','47':'okinawa','29':'nara','33':'okayama','40':'fukuoka',
             '23':'aichi','44':'oita','34':'hiroshima','27':'osaka','41':'saga',
             '16':'toyama','17':'ishikawa','05':'akita','09':'tochigi','21':'gifu',
             '14':'kanagawa','15':'niigata'}
PREF_REGION = {'22':'中部','47':'九州','29':'近畿','33':'中国','40':'九州',
               '23':'中部','44':'九州','34':'中国','27':'近畿','41':'九州',
               '16':'中部','17':'中部','05':'東北','09':'関東','21':'中部',
               '14':'関東','15':'中部'}
...
for m in staging:
    ...
    if m['prefecture_code'] not in BLOCK_A_PREFS: continue
    pref_roma = PREF_ROMA.get(m['prefecture_code'], 'japan')
    region = PREF_REGION.get(m['prefecture_code'], '中部')
...
print('ブロックA投入対象:', len(new_records), '件')
